...
var DefaultURL = "http://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/troubleTicket/v2/";
var schema;
var hostname;
var port;
var APIRelativeAddress;
var statusCode;
const exampleEndPoint = "troubleTicket";
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout
});

console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF621 TroubleTicket\n");
getURL();
...
function getURL(){
    ...
    rl.question('////////////////////////////////////////////////////////////////////////\nWhat is your full API address omiting the endpoint? example:\nhttp://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/troubleTicket/v2/troubleTicket\nbecomes\nhttp://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/troubleTicket/v2/\n>', (answer) => {
    DefaultURL = answer;
    rl.close();
    isURLValid(answer);
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF621-TroubleTicket.postman_collection.json'),
